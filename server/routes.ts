        ...
        [
          {
            ...
            content: [
              ...
              "DEFAULT SHAPE — build the rewrite in this order unless the story demands otherwise: [who — their name or ethos anchor, in THEIR words] + [what they do — THEIR nouns, never synonyms] + [where, only if local] + [turn or stakes] + [payoff].",
              ...
              "4. CATEGORY FIDELITY — word choice IS market positioning. Reuse the user's OWN nouns for what they do; NEVER substitute a synonym that names a different category ('IT help' is not 'computer repair' is not 'managed services'). Weave keywords in as whole words in real sentences, near the front where possible — never stuff, never list, never bolt them on. But if a supplied keyword names a different category than the story itself, keep the rewrite true to the story's nouns, leave that keyword out, and add a tip quoting both words: your keyword 'X' and your story's 'Y' name different categories — pick the one you want to be found as. Never rank categories or guess market tiers.",
