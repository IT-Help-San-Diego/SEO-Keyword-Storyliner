...
- Status as of July 4, 2026: force-push done (main rewritten, transcript-free, tip 8dc43d0), all 6 dependabot branches deleted, artwork present at tip and build passes; GitHub Support purge of cached orphan commits still pending. Re-checked later on July 4, 2026: old commit URLs (716a293, 79ad6d9) still return 200 on both the web UI and the commits API while compare API still 404s — Support purge has not landed yet; user should follow up with GitHub Support.
